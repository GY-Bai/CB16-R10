...
| 仓库级长期 TODO / 技术债 | **[MAIN_TODO](MAIN_TODO.md)** |
...
| Shanxi Docker live contract | [SHANXI_DOCKER_RUNNER_CONTRACT](infra/SHANXI_DOCKER_RUNNER_CONTRACT.md)；机器快照见 `authority/infra/SHANXI_DOCKER_RUNNER_SNAPSHOT_V1.json` |
