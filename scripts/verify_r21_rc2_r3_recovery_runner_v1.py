...
PROFILE_SPEC_PATH = REPO_ROOT / "infra" / "shanxi_runner" / "runner_launch_spec_r21_v1.json"
PROFILE_ID = "R21_RC2_FAST_HOT_RUNNER_V1"
...
def verify(repo_root: Path = REPO_ROOT) -> list[dict[str, Any]]:
    ...
    _check(checks, "profile_schema", spec.get("schema") == "CB16_SHANXI_RUNNER_LAUNCH_SPEC_R21_V1", str(spec.get("schema")))
